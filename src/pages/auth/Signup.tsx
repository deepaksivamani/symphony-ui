...
const Signup = () => {
  return (
    ...
    <div className="w-full max-w-md bg-gray-800" >
      <p className="bg-gray-600 text-white p-2">Signup</p>
      <form action="" className=" bg-white shadow-md px-8 py-8 pt-8">
        <div className="px-4 pb-4">
          <label htmlFor="first-name" className="text-sm block font-bold  pb-2">First Name</label>
          <input type="text" name="first-name" id="" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-blue-300 " placeholder="John" />
        </div>
        <div className="px-4 pb-4">
          <label htmlFor="last-name" className="text-sm block font-bold  pb-2">Last Name</label>
          <input type="text" name="last-name" id="" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-blue-300 " placeholder="Wright" />
        </div>
        <div className="px-4 pb-4">
